...
public class CrossingGate extends Observable implements Observer {
	...
	private double train1X;
	private double train2X;
	...
	public void update(Observable o, Object arg) {
		if (o instanceof Train) {
			...
			if (!train.getDirection())
				train1X = train.getVehicleX();
			else
				train2X = train.getVehicleX();

			if (train1X < exitPoint && train2X > triggerPoint)
				currentGateState.leaveStation();
			else if (train1X < triggerPoint || train2X > exitPoint)
