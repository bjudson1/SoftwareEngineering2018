...
public class Simulation extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		Train train1 = new Train(track1.getEndX() + 100, track1.getEndY() - 25, false);
		root.getChildren().add(train1.getImageView());

		// Train
		RailwayTracks track2 = mapBuilder.getTrack("Penn");
		Train train2 = new Train(track2.getStartX() - 100, track2.getStartY() - 25, true);
