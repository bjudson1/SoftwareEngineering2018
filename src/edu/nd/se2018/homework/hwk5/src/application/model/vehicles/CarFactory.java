...
public class CarFactory {
	...
	private boolean makeCrossingCars;
	Direction direction;
	Point location;
	...
	public CarFactory(Direction direction, Point location, Collection<CrossingGate> gates, boolean makeCrossingCars) {
		this.direction = direction;
		this.location = location;
		this.gates = gates;
		this.makeCrossingCars = makeCrossingCars;
	}
	...
	public Car buildCar() {
		if (previousCar == null || location.y < previousCar.getVehicleY() - 100) {
			...
			// if selected randomy add crosing cars
			if (makeCrossingCars) {
